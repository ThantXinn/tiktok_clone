          ...
          <div className='flex w-full py-2 sm:py-0 gap-2 sm:gap-0 justify-center'>
            ...
            <div className='flex flex-col w-full relative max-sm:-left-1'>
              ...
              <div className='flex py-3 gap-2 w-full'>
                ...
                <div className='flex flex-col lg:gap-10 gap-7 justify-end p-3 *:rounded-full *:px-2 *:bg-slate-100 *:h-10 *:w-10 max-sm:relative max-sm:left-[170px] max-[375px]:left-32 max-sm:gap-8 max-sm:*:text-xs max-sm:*:w-8 max-sm:*:h-8 max-sm:-bottom-40 *:relative *:cursor-pointer'>
